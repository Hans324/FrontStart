...
return (
    ...
    <section className='section-Home'>
      ...
      <p className='text-CSS'>CSS (Cascading Style Sheets) est un langage apparu en 1996 qui sert à styliser les pages HTML.
      ...
      <p className='text-JavaScript'>JavaScript est un langage de programmation créé en 1995 par Brendan Eich.
      ...
      <p className='text-Git'>Git est un outil de gestion de versions créé en 2005 par Linus Torvalds (créateur de Linux).
      ...
      <p className='text-React'>React est une bibliothèque JavaScript créée par Facebook en 2013.
